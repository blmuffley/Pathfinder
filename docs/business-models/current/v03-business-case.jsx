...
const pricingTiers = [
  {
    ...
    minHosts: 0,
    features: [
      "Pathfinder Discovery Engine (eBPF + ETW + K8s agents)",
      "Gateway classification engine + behavioral confidence scoring",
      "CMDB Ops — automated hygiene, CI lifecycle, stale record detection",
      "ServiceNow workspace (Polaris)",
      "Agentless network device discovery (free)",
    ...
    target: "Mid-market to enterprise, CMDB accuracy & governance",
  },
  {
    tier: "Professional",
    price: "100K",
    ...
    features: [
      ...
      "Integration Intelligence (data flow analysis, anomaly detection)",
      "AI health scoring, summarization, EA reconciliation",
      "Integration rationalization",
      "Service Map Intelligence (dependency mapping, validation)",
      "Unmapped service detection",
      "Health Dashboard + analytics",
    ],
    excluded: [],
    target: "Enterprise with integration complexity & service map needs",
    popular: true,
  },
];

const pricingByTier = [
  { tier: "S", nodes: "Up to 500", standard: "$50,000/yr", professional: "$100,000/yr" },
  { tier: "M", nodes: "501 – 2,000", standard: "$90,000/yr", professional: "$175,000/yr" },
  { tier: "L", nodes: "2,001 – 5,000", standard: "$150,000/yr", professional: "$250,000/yr" },
  { tier: "XL", nodes: "5,001+", standard: "Starting at $200,000/yr", professional: "Custom" },
];

// ── UPDATED: Revenue projections with 4-product portfolio ──

// ── UPDATED: Dual-scenario revenue projections ──
// Scenario A: Moderate Growth (displayed by default)
const revenueProjection = [
  {
    year: "Year 1", label: "Build + First Customers",
    newCustomers: 16, avgHosts: 0, avgPrice: 0, churn: 0,
    endCustomers: 16, endARR: 1200000, revenue: 600000,
    headcount: 7, opex: 1800000,
    note: "16 initial customers on Standard ($50K/yr S-tier). 0% Std→Pro upgrade. 5% logo churn.",
  },
  {
    year: "Year 2", label: "Std→Pro Upgrades Begin",
    newCustomers: 24, avgHosts: 0, avgPrice: 0, churn: 2,
    endCustomers: 38, endARR: 3800000, revenue: 2500000,
    headcount: 10, opex: 2400000,
    note: "15% Std→Pro upgrade rate. 8% logo churn. Standard surfaces gaps driving Professional upgrades.",
  },
  {
    year: "Year 3", label: "Channel Flywheel",
    newCustomers: 38, avgHosts: 0, avgPrice: 0, churn: 4,
    endCustomers: 72, endARR: 8500000, revenue: 6200000,
    headcount: 14, opex: 3400000,
    note: "25% Std→Pro upgrade. 3% price increase. CoreX consultants drive upgrade conversations.",
  },
  {
    year: "Year 4", label: "Scale",
    newCustomers: 55, avgHosts: 0, avgPrice: 0, churn: 7,
    endCustomers: 120, endARR: 17500000, revenue: 13000000,
    headcount: 16, opex: 5200000,
    note: "35% Std→Pro upgrade. 3% price increase. Portfolio flywheel: Pathfinder → Bearing → Contour → Vantage.",
  },
  {
    year: "Year 5", label: "Market Leadership (Moderate)",
    newCustomers: 84, avgHosts: 0, avgPrice: 0, churn: 12,
    endCustomers: 217, endARR: 33200000, revenue: 25000000,
    headcount: 16, opex: 5500000,
    note: "~$33.2M ARR at 89.6% EBITDA. Penetration scenario: 546 customers, ~$84M ARR at 91.6% EBITDA.",
  },
];
        ...
        {tab === "revenue" && (
          <div>
            ...
            <div style={{ display: "flex", gap: 4, marginBottom: 20, background: C.bgCard, borderRadius: 8, padding: 4, width: "fit-content" }}>
              {[
                { label: "Bear", mult: 0.4 },
                { label: "Likely (Base)", mult: 1.0 },
                { label: "Bull", mult: 1.3 },
                { label: "Best Case", mult: 1.6 },
              ].map(s => (
